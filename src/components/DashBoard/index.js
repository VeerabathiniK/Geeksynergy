...
const DashBoard = () => (
  <div className="dash-container">
    <h1 className="heading-account">Accounts</h1>
    <div className="box-container">
      <div className="box">
        <div className="content">
          <h1 className="sub">$12,750</h1>
          <p className="p2">Credit</p>
        </div>
        <img
          src="https://res.cloudinary.com/dobt9633l/image/upload/v1690798169/account_kjq4pp.svg"
          alt="props"
          className="image1"
        />
      </div>
      <div className="box2">
        <div>
          <h1 className="sub2">$5,600</h1>
          <p className="p2">Debit</p>
        </div>
        <img
          src="https://res.cloudinary.com/dobt9633l/image/upload/v1690798607/account2_gwpxuc.svg"
          alt="props"
          className="second"
        />
      </div>
    </div>
    <h1 className="heading2">Last Transaction</h1>
    <div className="sub-boxes">
      <svg
        ...
        fill="none"
      >
        <circle cx="15" cy="15" r="14" stroke="#FE5C73" />
        <path
      ...
      <p className="para2">Spotify Substraction</p>
      <p className="sub-para2">Shopping</p>
      <p className="date2">28 Jan, 12.30 AM</p>
      <p className="money2">-$150</p>
    ...
    <div className="sub-boxes">
      ...
      <p className="para2">Mobile Service</p>
      <p className="sub-para2">Service</p>
      <p className="date2">25 Jan, 10.40 PM</p>
      <p className="money2">-$150</p>
    ...
    <div className="sub-boxes">
      <svg
        ...
        fill="none"
      >
        <circle cx="15" cy="15" r="14" stroke="#16DBAA" />
        <path
      ...
      <p className="para2">Emilly Wilson</p>
      <p className="sub-para2">Transfer</p>
      <p className="date2">25 Jan, 10.40 PM</p>
      <p className="money3">+$780</p>
    ...
    <h1 className="heading3">Debit & Credit Overview</h1>
    <div className="trans-container">
      <div className="container">
        ...
        <div className="dot-container">
          <p className="dot">
            .<span className="style">Debit</span>
          </p>
          <p className="dot2">
            . <span className="style">Credit</span>
          </p>
        </div>
      </div>
      <svg
        ...
        fill="none"
      >
        <rect y="99" width="30" height="135" rx="10" fill="#4D78FF" />
        <rect x="40" width="30" height="234" rx="10" fill="#FCAA0B" />
      </svg>
      <svg
        className="poll"
        xmlns="http://www.w3.org/2000/svg"
        ...
        fill="none"
      >
        <rect y="80" width="30" height="106" rx="10" fill="#4D78FF" />
        <rect x="40" width="30" height="186" rx="10" fill="#FCAA0B" />
      </svg>
      <svg
        className="poll"
        xmlns="http://www.w3.org/2000/svg"
        ...
        fill="none"
      >
        <rect y="37" width="30" height="102" rx="10" fill="#4D78FF" />
        <rect x="40" width="30" height="139" rx="10" fill="#FCAA0B" />
      </svg>
      <svg
        className="poll"
        xmlns="http://www.w3.org/2000/svg"
      ...
      >
        ...
        <rect x="40" y="89" width="30" height="123" rx="10" fill="#FCAA0B" />
      </svg>
      <svg
        className="poll"
        xmlns="http://www.w3.org/2000/svg"
        ...
        fill="none"
      >
        <rect y="64" width="30" height="150" rx="10" fill="#4D78FF" />
        <rect x="40" width="30" height="214" rx="10" fill="#FCAA0B" />
      </svg>
      <svg
        className="poll"
        xmlns="http://www.w3.org/2000/svg"
      ...
      >
        ...
        <rect x="40" y="53" width="30" height="105" rx="10" fill="#FCAA0B" />
      </svg>
      <svg
        className="poll"
        xmlns="http://www.w3.org/2000/svg"
        ...
        fill="none"
      >
        <rect y="37" width="30" height="179" rx="10" fill="#4D78FF" />
        <rect x="40" width="30" height="216" rx="10" fill="#FCAA0B" />
      </svg>
    </div>
  </div>
)
